...
# Appliquer la rotation Y = -45°
deselect_all_bones(get_armature())
run_rotation_on_bones(bone_list1, -math.radians(45), axis='Y')

# Appliquer la rotation Z = +18°
run_rotation_on_bones(bone_list2, math.radians(18), axis='Z')
